...
rf=RandomForestRegressor(n_estimators=480,max_features='auto',random_state=7)

# 使用最佳筛选后的特征，利用相同配置的模型在测试集上进行性能评估。
from sklearn import feature_selection
fs = feature_selection.SelectPercentile(feature_selection.f_regression, percentile=60)
...
VNames = np.array(['A1', 'A3', 'A4','B1', 'B2', 'B3'])
#print VNames
